...
public class PropertyControllerTest {
    ...
    @InjectMocks
    private PropertyController propertyController;//Mockito is going to create a proxy object of PropertyController and inject it to our PropertyControllerTest
